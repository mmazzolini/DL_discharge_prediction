...
def create_in_m(daily_input, t_length,t_unit):
    ...
    if not daily_input.empty:
        ...
        output = pd.concat([shift_series_dl(daily_input_t_unit[col], (-t_length + 1, 1),t_unit) for col in daily_input_t_unit], axis=1)
...
def shift_series_dl(s, shift_range,t_unit):
